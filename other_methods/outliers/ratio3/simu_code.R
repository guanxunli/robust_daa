...
for (iter_para in seq_len(n_setting)) {
  ...
  saveRDS(aldex2_res, paste0(
    "other_methods/", outlier,  "/", ratio, "/results/aldex2_nocon_n", n,
    "gamma", gamma, "mu", mu_use, ".rds"
  ))
  ...
  saveRDS(ancombc_res, paste0(
    "other_methods/", outlier,  "/", ratio, "/results/ancombc_nocon_n", n,
    "gamma", gamma, "mu", mu_use, ".rds"
  ))
  ...
  saveRDS(maaslin2_res, paste0(
    "other_methods/", outlier,  "/", ratio, "/results/maaslin2_nocon_n", n,
    "gamma", gamma, "mu", mu_use, ".rds"
  ))
}